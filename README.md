...
- **Cross-Aircraft Weapon Transfer** — Copies QoL-added weapon loadouts from vanilla aircraft to Aryx equivalents (Chicane->Knockout, Revoker->F-99, Cricket->MiG-15, Vortex->F-16M). Station 0 is excluded.
